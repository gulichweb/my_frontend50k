...
//     let price = this.parentNode.parentNode.parentNode.parentNode.querySelectorAll(".price del");
...
//     console.log(src[0].innerText);
   

//     creat_li.innerHtML = `<div class="left">
//                          <div class="left"><img src="'+src[0].innerText+'" alt=""></div>
//                           <div class="right m-l-10"><p>Crepe Jacket With Pompom.</p><p>$36.00 <del> $42.00</del> </p>

...
function add_to_cart(delete_product, total_price, count_product) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#accord .accordion').one('click', function () {
    // alert( 'Вы нажали на елемент "#foo"');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#accord .panel').not(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).next()).slideUp(500);
